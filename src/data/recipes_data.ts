...
export function scoreRecipe(recipe: Recipe, selected: string[]): number {
...
export function findSimilarRecipes(recipe: Recipe, count: number = 3): Recipe[] {
